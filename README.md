...
Your Chat ID will be shown in this format **`"id":7041782343`** and based on this example your Chat ID should be **`7041782343`**. The second way is through a third party telegram bot called [**@get_id_bot**](https://telegram.me/get_id_bot)
