...
This script will allow you to choose whether to have your votes automated daily, or just have it claim your BP<br>rewards daily instead. You can also set it up to do both these tasks if you prefer having these tasks automated.<br>Please note for this script to work you must have already setup your "vote" and "claim" account permissions.<br>
<br>
...
<br>
```
sudo wget https://github.com/SooSDExZ/REMChain-Automated-Bot/raw/master/vote.sh && sudo chmod u+x vote.sh && sudo ./vote.sh
```
